...
> Полный список полей доступен на [MOEX ISS](https://iss.moex.com/iss/engines/stock/markets/shares/).
...
- [Модели данных](#модели-данных)
  ...
  - [`Dividends`](#dividends---выплаты-дивидендов )
- [Режимы торгов](#режимы-торгов)


## Быстрый старт

Получение данных об акции по её идентификатору:
...
Статические параметры выпуска: идентификаторы, дивиденды и другие характеристики акции.
