...
| `value` | `value` | `Decimal` | Сумма выплаты. Для будущих выплат флоатеров может быть неизвестна (None) |
| `valueprc` | `value_prc` | `Decimal` | Размер купона в процентах годовых от номинала |
| `faceunit` | `face_unit` | `str` | Валюта номинала |

---

### Амортизация (Amortizations)
График частичного или полного погашения номинала облигации.

| Поле (API) | Атрибут в SDK | Тип в Python | Описание |
| --- | --- | --- | --- |
| amort_date | amort_date | Decimal | Дата выплаты части номинальной стоимости |
